//! SQLite上のファイルフィンガープリントと重複グループの永続化・読み取り。
...
use crate::types::{
	DetectedDuplicateGroup, DuplicateFileRecord, DuplicateGroupRecord, DuplicateMethod,
	DuplicateRefreshSummary, FileFingerprint, StoredFileFingerprint,
};
