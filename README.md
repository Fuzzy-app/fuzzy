...
別PCでの動作確認には、未署名の[Fuzzy v0.1.0-qa.3 Pre-release](https://github.com/Fuzzy-app/fuzzy/releases/tag/v0.1.0-qa.3)を使用します。これは正式版ではありません。参加方法と注意事項は[QAプレリリースの試し方](docs/公開ガイド/QAプレリリース.md)を参照してください。
