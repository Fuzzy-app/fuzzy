...
- 上級者D: `apps/desktop/src-tauri`、`packages/shared`、`extension/background`・`content`、`docs/api/contract.md`
- 初心者1: `apps/extension`（popup）
- 初心者2: `apps/desktop/src`（setup・rules）
- 初心者3(PM): `apps/desktop/src`（search・deadlines・dashboard）
